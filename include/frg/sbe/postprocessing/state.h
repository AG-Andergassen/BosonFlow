...
class state_postproc_t: public state_vector_frg_base_t<Model,
    ...
    gf_Sig_SDE_integrand_t<Model>, gf_Sig_SDE_integrand_t<Model>, gf_Sig_SDE_integrand_t<Model>,
    gf_static_lambda_t<Model>, gf_static_lambda_t<Model>, gf_static_lambda_t<Model>, //rest functions contribution to lambda
    gf_static_lambda_t<Model>, gf_static_lambda_t<Model>, gf_static_lambda_t<Model>, // Virr contributions
    gf_static_lambda_t<Model>, gf_static_lambda_t<Model>, gf_static_lambda_t<Model>
> 
  /**< Type of the state vector of the ODE solver. @see arithmetic_tuple.h for ReaK wrapper */
{
 public:
	...
	gf_static_lambda_t<Model>, gf_static_lambda_t<Model>, gf_static_lambda_t<Model>, // Vbare contributions
        gf_static_lambda_t<Model>, gf_static_lambda_t<Model>, gf_static_lambda_t<Model>, // varphi contributions
	gf_Sig_SDE_integrand_t<Model>, gf_Sig_SDE_integrand_t<Model>, gf_Sig_SDE_integrand_t<Model>, // SDE sigma integrands
      gf_static_lambda_t<Model>, gf_static_lambda_t<Model>, gf_static_lambda_t<Model>, // rest function contributions
	gf_static_lambda_t<Model>, gf_static_lambda_t<Model>, gf_static_lambda_t<Model>,
	gf_static_lambda_t<Model>, gf_static_lambda_t<Model>, gf_static_lambda_t<Model>
     >; 
    ...
    using Sig_integrand_t = gf_Sig_SDE_integrand_t<Model>;
    ...
    inline Sig_integrand_t& gf_Sig_SDE_integrand_sc()			        { return std::get<state_base_t::offset_idx(85)>( *this ); }    
    inline const Sig_integrand_t& gf_Sig_SDE_integrand_sc() const	        { return std::get<state_base_t::offset_idx(85)>( *this ); }    

    inline Sig_integrand_t& gf_Sig_SDE_integrand_d()			        { return std::get<state_base_t::offset_idx(86)>( *this ); }    
    inline const Sig_integrand_t& gf_Sig_SDE_integrand_d() const	        { return std::get<state_base_t::offset_idx(86)>( *this ); }    

    inline Sig_integrand_t& gf_Sig_SDE_integrand_m()			        { return std::get<state_base_t::offset_idx(87)>( *this ); }    
    inline const Sig_integrand_t& gf_Sig_SDE_integrand_m() const	        { return std::get<state_base_t::offset_idx(87)>( *this ); }


  // rest function contributions to lambda
    inline static_lambda_t& gf_lambda_sc_contribution_from_M_d()			        { return std::get<state_base_t::offset_idx(88)>( *this ); }    
    inline const static_lambda_t& gf_lambda_sc_contribution_from_M_d() const	        { return std::get<state_base_t::offset_idx(88)>( *this ); }    

    inline static_lambda_t& gf_lambda_sc_contribution_from_M_m()			        { return std::get<state_base_t::offset_idx(89)>( *this ); }    
    inline const static_lambda_t& gf_lambda_sc_contribution_from_M_m() const	        { return std::get<state_base_t::offset_idx(89)>( *this ); }    

    inline static_lambda_t& gf_lambda_sc_contribution_from_M_sc()			        { return std::get<state_base_t::offset_idx(90)>( *this ); }    
    inline const static_lambda_t& gf_lambda_sc_contribution_from_M_sc() const	        { return std::get<state_base_t::offset_idx(90)>( *this ); }    



    inline static_lambda_t& gf_lambda_d_contribution_from_M_d()			        { return std::get<state_base_t::offset_idx(91)>( *this ); }    
    inline const static_lambda_t& gf_lambda_d_contribution_from_M_d() const	        { return std::get<state_base_t::offset_idx(91)>( *this ); }    

    inline static_lambda_t& gf_lambda_d_contribution_from_M_sc()			        { return std::get<state_base_t::offset_idx(92)>( *this ); }    
    inline const static_lambda_t& gf_lambda_d_contribution_from_M_sc() const	        { return std::get<state_base_t::offset_idx(92)>( *this ); }    

    inline static_lambda_t& gf_lambda_d_contribution_from_M_m()			        { return std::get<state_base_t::offset_idx(93)>( *this ); }    
    inline const static_lambda_t& gf_lambda_d_contribution_from_M_m() const	        { return std::get<state_base_t::offset_idx(93)>( *this ); }    


    inline static_lambda_t& gf_lambda_m_contribution_from_M_m()			        { return std::get<state_base_t::offset_idx(94)>( *this ); }    
    inline const static_lambda_t& gf_lambda_m_contribution_from_M_m() const	        { return std::get<state_base_t::offset_idx(94)>( *this ); }    

    inline static_lambda_t& gf_lambda_m_contribution_from_M_sc()			        { return std::get<state_base_t::offset_idx(95)>( *this ); }    
    inline const static_lambda_t& gf_lambda_m_contribution_from_M_sc() const	        { return std::get<state_base_t::offset_idx(95)>( *this ); }    

    inline static_lambda_t& gf_lambda_m_contribution_from_M_d()			        { return std::get<state_base_t::offset_idx(96)>( *this ); }    
    inline const static_lambda_t& gf_lambda_m_contribution_from_M_d() const	        { return std::get<state_base_t::offset_idx(96)>( *this ); }    
