...
class SquareHubbardLongRange : public SquareHubbard
{
 public:
    SquareHubbardLongRange() = delete;
    
    static const std::string GetName(){return "Square Hubbard-LongRange";};
    ...
    {
        return  {{ "Q", SquareHubbardLongRangeParams::Q }, { "K_s", SquareHubbardLongRangeParams::K_s }, { "U", SquareHubbardParams::UINT }, { "V", SquareHubbardParams::VINT }, { "TP", SquareHubbardParams::T_PRIME}, {"Mu", SquareHubbardParams::MU}, {"KDIM", K_DIM}, {"FineMoms", GetFineMomentaCount()}, {"RefdMoms", GetRefinedMomentaCount()}, {"FFShellCount", FORMFACTOR_SHELL_COUNT}};
    };
  ...
  static void PrecomputeV0_local();

  static double &PrecomputedV0_local()
  {
    static double precomputed_V0_local;
    return precomputed_V0_local;
  }
