...
class SquareHubbardPeierls : public SquareHubbard
{
 public:
    SquareHubbardPeierls() = delete;
    
    static const std::string GetName(){return "Square Hubbard-Peierls";};
    ...
    {
        return  {{ "g0", SquareHubbardPeierlsParams::g0 }, { "OMEGA0", SquareHubbardPeierlsParams::OMEGA0 }, { "U", SquareHubbardParams::UINT }, { "V", SquareHubbardParams::VINT }, { "TP", SquareHubbardParams::T_PRIME}, {"Mu", SquareHubbardParams::MU}, {"KDIM", K_DIM}, {"FineMoms", GetFineMomentaCount()}, {"RefdMoms", GetRefinedMomentaCount()}, {"FFShellCount", FORMFACTOR_SHELL_COUNT}};
    };
