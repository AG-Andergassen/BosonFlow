...
class HubbardAtom : public Hubbard<0>
{
 public:
    HubbardAtom() = delete;
    
    static const std::string GetName(){return "Hubbard Atom";};
    ...
    {
        return {{ "U", HubbardAtomParams::UINT }, {"Mu", HubbardAtomParams::MU}, {"KDIM", K_DIM}, {"FineMoms", GetFineMomentaCount()}, {"RefdMoms", GetRefinedMomentaCount()}, {"FFShellCount", FORMFACTOR_SHELL_COUNT}};
    };
